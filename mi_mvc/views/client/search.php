...
if (isset($_REQUEST["evento"])) {
    ...
    switch ($_REQUEST["evento"]) {
        ...
        case "filtrar":
            ...
            $clients = $controlador->buscar($client, $campo, $metodo);
            break;
        case "borrar":
    ...
    <div id="contenido">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input type="text" required class="form-control" id="busqueda" name="busqueda" value="<?= $client ?>" placeholder="Buscar por Usuario">
            </div>
