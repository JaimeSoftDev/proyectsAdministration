...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div
        ...
        <h1 class="h3">Editar Usuario
            <?= $_SESSION["datos"]["usuario"] ?? $user->usuario ?> con Id:
            <?= $id ?>
        </h1>
    </div>
    <div id="contenido">
        ...
        if ($mostrarForm) {
            ...
            <form action="index.php?tabla=user&accion=guardar&evento=modificar" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control" id="usuario" name="usuario" aria-describedby="usuario"
                        value="<?= $_SESSION["datos"]["usuario"] ?? $user->usuario ?>">
